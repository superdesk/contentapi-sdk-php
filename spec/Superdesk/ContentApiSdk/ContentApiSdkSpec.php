...
class ContentApiSdkSpec extends ObjectBehavior
{
    ...
    function its_method_get_item_should_return_an_item(Client $client)
    {
    ...
    function its_method_get_items_should_return_null_for_no_items(Client $client)
    {
    ...
    function its_method_get_items_should_return_items_for_items(Client $client)
    {
        $parameters = array('start_date' => '1970-01-01');
    ...
    function its_method_get_package_should_return_a_package(Client $client)
    {
    ...
    function its_method_get_packages_should_return_null_for_no_packages(Client $client)
    {
        $parameters = array('start_date' => '1970-01-01');
    ...
    function its_method_get_packages_should_return_packges_for_packages(Client $client)
    {
        $parameters = array('start_date' => '1970-01-01');
